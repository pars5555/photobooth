...
require_once (CLASSES_PATH . "/dal/dto/CarwashDto.class.php");

/**
 *

 */
class CarwashMapper extends AbstractMapper {
    ...
    public static function getInstance() {
        if (self::$instance == null) {
            self::$instance = new CarwashMapper();
        }
    ...
    public function getByLoginPassword($login, $password) {
        $sqlQuery = sprintf(self::$GET_USER_BY_USERNAME_AND_PASS, $this->getTableName(), $login, $password);
